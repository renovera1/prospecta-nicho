...
O link `https://renovera1.github.io/renovera-projetos-eletricos/` é publicação estática. Formulários que dependem de API precisam de fallback estático ou endpoint externo.
